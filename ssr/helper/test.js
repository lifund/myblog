...
const fileNameArray = await getFileName_recursive('/Users/jangwonseo/myblog/ssr/src/components','.js');
// console.log(
...
const dirNameArray = await getDirName_recursive('/Users/jangwonseo/myblog/ssr/src/components','.js');
// console.log(
...
const fileName = '/Users/jangwonseo/myblog/ssr/src/components/App.js'
...
import getLocalAddress from "./dist/getLocalAddress.js"
